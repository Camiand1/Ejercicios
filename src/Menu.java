...
public class Menu {
    ...
    public void menuCompleto() {
        ...
        System.out.println("Ejercicio 1. Indica que número es mayor, menor o igual.\n" +
                ...
                "Ejercicio 7. Digitar un número por consola que indica si es mayor o igual a cero, si no cumple, se volverá a pedir.\n" +
                ...
                "Ejercicio 16. Pide por teclado el nombre, la edad, sexo, peso y altura, mostrará, luego pide por teclado nombre, edad y sexo.\n" +
                "Mostrará estos datos más otros por defecto.\n" +
                "Ejercicio 17. Mostrará el precio de todos los televisores, el de las lavadoras y la suma del precio de todos los Electrodomésticos.\n" +
                "Ejercicio 18. Indicará el Video juego que tiene más horas estimadas y la serie con más temporadas. Y también toda su información. \n");
