...
public class Persona {
    ...
    private int PESOBAJO = 0;
    private int SOBREPESO = 1;
    private int PESOIDEAL = -1;
    ...
    public double calcularIMC() {
        ...
        if(calculoIMC<20){
            System.out.println(PESOIDEAL + " - Su peso es ideal\n");
        }else if (calculoIMC >=20 &&  calculoIMC <=25){
            System.out.println(PESOBAJO+" - Está por debajo de su peso ideal\n");
        }else if(calculoIMC >25){
            System.out.println(SOBREPESO+" - Tiene sobrepeso\n");
        }return calculoIMC;
    }
    ...
    public boolean esMayorDeEdad(){
        ...
        if (edad>17){
            ...
            System.out.println("No tiene la mayoría de edad\n");
        }return mayorEdad;
    }
    ...
    public void ejercicioDieciSeis(){
        ...
        System.out.println("Se calcuará su IMC, si tiene la mayoria de edad de acuerdo a unos datos pedidos por teclado, de dos personas y una por defecto.\n");
        Scanner teclado = new Scanner(System.in);
        System.out.println("Digite su nombre: ");
        nombreIngresado = validadorPalabra.validacionPalabra(teclado);
